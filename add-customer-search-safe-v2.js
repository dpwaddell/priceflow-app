...
const BACKUP_DIR = path.join(
  APP_ROOT,
  "backups",
  `${new Date().toISOString().replace(/[:.]/g, "-")}_phase6_customer_search_safe_v2`
);
...
function replaceBetween(txt, startMarker, endMarker, replacement, label) {
...
`;
  ...
  txt = replaceBetween(
    ...
    newGetRoute + 'app.post("/customer-assignments", async (req, res) => {',
